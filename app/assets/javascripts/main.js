...
function afterMapLoad(){
    ...
    */
    ...
    if(navigator.geolocation){
      ...
      navigator.geolocation.getCurrentPosition(zoomToLocation, function(){ alert("error"); });
...
function getRainbows ( location )
{
      ...
      var lat = location.coords.latitude;
        $.ajax({
            ...
            url: '/find_rainbows/find?latitude='+lat+'&longitude='+long,
